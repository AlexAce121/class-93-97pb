var firebaseConfig = {
    ...
    databaseURL: "https://lol-kwitter-default-rtdb.firebaseio.com",
...
function getData() { firebase.database().ref("/"+Room_name).on('value', function(snapshot) { document.getElementById("Chatbox").innerHTML = ""; snapshot.forEach(function(childSnapshot) { childKey = childSnapshot.key; childData = childSnapshot.val(); if(childKey != "purpose") { firebase_message_id = childKey; message_data = childData; 
    console.log(firebase_message_id);
    console.log(message_data);
    var n = message_data['name'];
    var msg = message_data['message'];
    var like = message_data['likes'];
    nametag = "<h4>"+n+"<img class='user_tick' src='verified-blue-tick-clipart-2.jpg'> </h4>";
